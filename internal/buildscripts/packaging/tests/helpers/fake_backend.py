...
def _make_fake_ingest(datapoint_queue, events, spans, logs, save_datapoints, save_events, save_spans, save_logs):
    app = Sanic()
...
def start(
    ...
    ingest_app = _make_fake_ingest(_dp_upload_queue, _events, _spans, _logs, save_datapoints, save_events, save_spans, save_logs)
