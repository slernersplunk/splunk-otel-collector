...
var (
	...
	errUnsupportedValueTypeString     = fmt.Errorf("unsupported value type string")
...
func setDataType(datapoint *sfxdatapoint.Datapoint, m pdata.Metric) error {
	...
	case sfxdatapoint.StringValue:
		return errUnsupportedValueTypeString
	}

	switch sfxMetricType {
	case sfxdatapoint.Gauge, sfxdatapoint.Enum, sfxdatapoint.Rate:
		if isFloat {
